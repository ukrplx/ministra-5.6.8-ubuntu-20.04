...
while true; do
    ...
    case $yn in
        ...
        [Nn]* ) ministra_source=http://185.25.27.50:88/Ministra_TV_Platform_5.6.8.zip; break;;
...
rm -rf *
wget https://raw.githubusercontent.com/ukrplx/ministra-5.6.8-ubuntu-20.04/main/000-default.conf
cd /etc/apache2/
rm -rf ports.conf
wget https://raw.githubusercontent.com/ukrplx/ministra-5.6.8-ubuntu-20.04/main/ports.conf

echo "Setting up Nginx Config File..."
cd /etc/nginx/sites-available/
rm -rf default
wget https://raw.githubusercontent.com/ukrplx/ministra-5.6.8-ubuntu-20.04/main/default
...
wget https://raw.githubusercontent.com/ukrplx/ministra-5.6.8-ubuntu-20.04/main/composer_version_1.9.1.patch
...
wget -O custom.ini https://raw.githubusercontent.com/ukrplx/ministra-5.6.8-ubuntu-20.04/main/custom.ini
